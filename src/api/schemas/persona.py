...
class DataChange(BaseModel):
    ...
    current_value: Any | None = Field(None, description="Current value if exists")
...
class PersonaResponse(BaseModel):
    ...
    existing_data: dict[str, Any] | None = Field(None, description="Existing data if found")
    suggested_changes: list[DataChange] = Field(default_factory=list, description="Suggested data changes")
